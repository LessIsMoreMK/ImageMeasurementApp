...
namespace ImageMeasurementApp
{
    public class WindowViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Change toolip for maximize button
        /// </summary>
        public string MaximizeText => mWindow.WindowState == WindowState.Maximized ? "Restore Down" : "Maximize";

        /// <summary>
        /// Change icon for maximize button
        /// </summary>
        public object MaximizeIcon => mWindow.WindowState == WindowState.Maximized ?
            Application.Current.Resources["FontAwesomeRestoreIcon"] : Application.Current.Resources["FontAwesomeMaximizeIcon"];
        ...
        /// <summary>
        /// The radius of the edge for close button
        /// </summary>
        public CornerRadius WindowCornerRadiusForCloseButton => new CornerRadius(0, WindowRadius, 0, 0);
        ...
        private void WindowResized()
        {
            ...
            OnPropertyChanged(nameof(WindowCornerRadiusForCloseButton));
            OnPropertyChanged(nameof(MaximizeText));
